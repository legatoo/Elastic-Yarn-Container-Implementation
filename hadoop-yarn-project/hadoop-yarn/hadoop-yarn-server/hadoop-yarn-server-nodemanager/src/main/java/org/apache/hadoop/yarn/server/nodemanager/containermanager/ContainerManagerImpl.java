...
public class ContainerManagerImpl extends CompositeService implements
    ...
    public ContainerManagerImpl(Context context, ContainerExecutor exec,
        ...
        containerSqueezer = createContainerSqueezer(context, exec);
        addService(containersLauncher);
        addService(containerSqueezer);
    ...
    protected ContainerSqueezer createContainerSqueezer(Context context, ContainerExecutor exec){
        return new ContainerSqueezer(context, this.dispatcher, exec, this);
    }
    @Override
    ...
    /**
     * @param containerTokenIdentifier of the container to be started
     * @throws YarnException
     */
    @Private
    @VisibleForTesting

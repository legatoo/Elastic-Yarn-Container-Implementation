...
public abstract class Container implements Comparable<Container> {
    ...
    @Public
    @Unstable
    public abstract boolean getIfSpeculative();

    @Public
    @Unstable
    public abstract Resource getPadding();

    @Public
    @Unstable
    public abstract void setIfSpeculative(boolean speculative);

    @Public
    @Unstable
    public abstract void setPadding(Resource Padding);

...
public class ContainerPBImpl extends Container {
    ...
    private Resource padding = null;

    // TODO: add label to distinguish speculative container and normal container
    // the difference between them are:
    // 1. speculative container is made with support squeezed container
    //    and can not be squeezed again
    // 2. normal container is made only with available resource
    //    and can be squeezed
    ...
    private void mergeLocalToBuilder() {
        ...
        if (this.padding != null
                && !((ResourcePBImpl) this.padding).getProto().equals(
                builder.getPadding())) {
            builder.setPadding(convertToProtoFormat(this.padding));
        }
    ...
    public Resource getPadding() {
        ...
        this.padding = convertFromProtoFormat(p.getPadding());
        return this.padding;
    }

    @Override
    public void setPadding(Resource padding) {
        maybeInitBuilder();
        if (padding == null)
    ...
    @Override
    public boolean getIfSpeculative() {
        ContainerProtoOrBuilder p = viaProto ? proto : builder;
        return p.getIfSpeculative();

    }

    @Override
    public void setIfSpeculative(boolean speculative) {
        maybeInitBuilder();
        builder.setIfSpeculative((speculative));
    }
    ...
    public String toString() {
        ...
        sb.append("Padding: ").append(getPadding()).append(", ");
        sb.append("Priority: ").append(getPriority()).append(", ");
        sb.append("Token: ").append(getContainerToken()).append(", ");
        sb.append("ifSpeculative: ").append(getIfSpeculative()).append(", ");
        sb.append("]");
        return sb.toString();
    }
